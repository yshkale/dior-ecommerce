...
const Checkout = function (props) {
  ...
  const [userInfo, setUserInfo] = useState({
    ...
    pinCode: "",
    phone: "",
    orderValue: props.checkoutTotal.toFixed(2),
  });
            ...
            <div>
              <div className="mb-2 flex justify-between">
                ...
                <p className="text-[1.3rem] font-semibold tracking-wide text-neutral-800">
                  $ {(props.checkoutTotal - 8.33).toFixed(2)}
                </p>
              </div>
              <div className="mb-2 flex justify-between">
                <p className="text-[1.3rem] tracking-widest text-neutral-900">
            ...
            <div className="border-b border-neutral-300 px-6 pt-12 lg:px-[40rem]">
              ...
              <div>
                ...
                <div>
                  ...
                  <p
                    className="my-6 text-center text-[1.3rem] tracking-wide text-neutral-700"
                    onClick={() => {
                      props.goToHome();
                      window.scrollTo(0, 0);
                    }}
